...
void main() {
  ...
  test('normalized base URL keeps relative paths under api', () {
    final baseUrl = normalizeApiBaseUrl('https://pos.sasalink.co.ke/api');

    expect(
      Uri.parse(baseUrl!).resolve(relativeApiPath('/auth/setup/status')).path,
